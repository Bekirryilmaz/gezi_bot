...
export function SiteFooter() {
  return (
    <footer className="border-t border-bordo/20 bg-deniz-derin text-kopuk">
      <div className="mx-auto flex max-w-6xl flex-col gap-3 px-4 py-10 md:flex-row md:items-end md:justify-between md:px-8">
        <div>
        ...
        <div className="flex flex-wrap gap-4 text-sm">
          <Link href="/oneriler" className="text-kopuk/80 hover:text-gunes">
            Önerim Var
          </Link>
